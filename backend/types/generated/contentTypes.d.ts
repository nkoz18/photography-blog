...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gallery: Schema.Attribute.Component<'sections.image-gallery', false>;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    browserName: Schema.Attribute.String;
    ...
    email: Schema.Attribute.Email;
    encounters: Schema.Attribute.Relation<
      'manyToMany',
    ...
    smsOptOut: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    viewportSize: Schema.Attribute.String;
...
export interface ApiPhotoEncounterPhotoEncounter
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    placeData: Schema.Attribute.JSON;
    placeName: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'address'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['pending', 'ready', 'archived']> &
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    browserInfo: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ipAddress: Schema.Attribute.String &
    ...
    isSubjectInImage: Schema.Attribute.Enumeration<['yes', 'no']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    otherReason: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    publishedAt: Schema.Attribute.DateTime;
    reason: Schema.Attribute.Enumeration<
      ['unflattering', 'inappropriate', 'copyright', 'other']
    > &
      Schema.Attribute.Required;
    reportedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    reportedImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::photo-encounter.photo-encounter': ApiPhotoEncounterPhotoEncounter;
